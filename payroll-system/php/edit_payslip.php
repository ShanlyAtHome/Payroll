...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $new_payroll_id = $_POST['payroll_id'] ?? null;
    $old_payroll_id = $_POST['old_payroll_id'] ?? null;

    if (!$new_payroll_id || !$old_payroll_id) {
        die("Error: Missing payroll IDs.");
    }
...
");
$stmt->bind_param("iiii", $new_payroll_id, $year, $employee_id, $old_payroll_id);
