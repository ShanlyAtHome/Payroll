            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(response => {
                    if (response.trim() === "success") {
                        ...
                        // show error message inside modal instead of closing
                        modalBody.innerHTML = response;
                    }
                })
                .catch(error => console.error("Error submitting payslip form:", error));
            });
        }
    })
            ...
            form.addEventListener("submit", function(e) {
                ...
                .then(data => {
                    ...
                    if (data.includes("success")) {
                        ...
                        // ✅ Redirect to dashboard with Payroll tab
                ...
                .catch(error => {
                    console.error("Error submitting edit payslip form:", error);
