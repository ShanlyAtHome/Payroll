...
<table style="width:100%; table-layout:fixed; border-collapse:collapse; margin-top: 10px;">
  ...
  <tbody>
    ...
    <tr style="font-weight:bold; background:#f9f9f9;">
      ...
      <td>
        <strong style="color: blue; font-weight: bold;">₱</strong>
...
<table id="govDeductions" border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse; width: 100%; text-align: left; margin-top: 0;">
  ...
  <tbody>
    ...
    <tr>
     ...
     <tr style="font-weight:bold; background:#f9f9f9;">
      <td style="color: red; font-weight: bold;">Total Deductions:</td>
      <td>
        <strong style="color: red; font-weight: bold;">₱</strong>
        <span id="total_deductions" style="color: red; font-weight: bold;">0.00</span>
      </td>
  </tbody>
</table>
