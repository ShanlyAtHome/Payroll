...
<div id="header_container">
  ...
  <div id="btn_actions">
    ...
    <div method="post" action="export.php" id="export-form">
        <input type="hidden" name="employee_id" value="<?= htmlspecialchars($value['employee_id']) ?>">
        <button id="ppayslip-export" type="submit" name="export" title="Export Payslip" value="csv">
          <i id="add_icon" class="fa-solid fa-file-export"></i>
        </button>
    </div>
...
<?php endwhile; ?>
  ...
  <?php else: ?>
    <p style="text-align:center; margin-top: 200px;">No payroll records found.</p>
  <?php endif; ?>
</div>
