        ...
        <?php while($row = $result->fetch_assoc()): ?>
          <tr data-id="<?= $row['employee_id'] ?>">
            ...
            <td>
              ...
              <a href="#" class="create-payslip-btn" onclick="loadEditPayslipModal(<?= $row['employee_id'] ?>)">Create Payslip</a>
...
<div class="modal fade" id="editPayslipModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add Payslip Information </h5> <p style="margin-left: 50px; margin-top: 12px;">Date: <?= date("F j, Y") ?></p>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
